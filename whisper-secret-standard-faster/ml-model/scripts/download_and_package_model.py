...
def create_sagemaker_package(model_dir, ml_model_dir, output_file):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        inference_py = ml_model_dir / "steep_hill" / "inference.py"
...
def main():
    ...
    parser.add_argument(
        "--s3-bucket",
        required=True,
        help="S3 bucket name for model artifacts (e.g., sagemaker-steep-hill-models-123456789-eu-west-1)",
    )
    parser.add_argument(
        "--model-name",
    ...
    parser.add_argument(
        "--output-dir", default="./steep_hill", help="Local directory to save model"
    )
    parser.add_argument(
        "--package-file",
