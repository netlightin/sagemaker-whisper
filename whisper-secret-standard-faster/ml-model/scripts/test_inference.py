...
# Add the ml-model/steep_hill directory to the path
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "steep_hill"))
...
def test_inference_pipeline():
    ...
    try:
        ...
        model_dir = "./ml-model/steep_hill/model"
        ...
        print(f"  - Compute type: {model_dict['compute_type']}")
        ...
        json_request = {"audio": audio_base64, "language": "en", "task": "transcribe"}
