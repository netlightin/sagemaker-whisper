...
pip install transformers torch soundfile librosa boto3
...
# This will:
# - Download Whisper Large V3 Turbo (~3GB)
# - Package with inference code
# - Create model.tar.gz (~1.4GB)
# - Upload to S3
```
...
# Push to ECR (will be created by Terraform)
