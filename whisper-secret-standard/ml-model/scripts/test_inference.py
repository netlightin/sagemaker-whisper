...
# Add the ml-model/loud_meadow directory to the path
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "loud_meadow"))
...
def test_inference_pipeline():
    ...
    try:
        ...
        model_dir = "./ml-model/loud_meadow/model"
